...
// Note: I have provided directional deltas in the form of a 2D array.
// An array is a C++ container much like a vector, although without the ability to change size after initialization.
// Arrays can be accessed and iterated over just as vectors.
// 
// directional deltas
...
bool CheckValidCell(int x, int y, vector<vector<State>>& grid)
{
	...
	if (on_grid_x && on_grid_y) return grid[x][y] == State::kEmpty;
	return false;
}
